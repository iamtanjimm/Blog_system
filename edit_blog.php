        ...
        <div class="col-xl-8 col-log-6">
            <div class="card">
                <div class="card-header">
                    <h6 class="font-weight-bold text-primary mt-2">Edit Food Items</h6>
                </div>
                <div class="card-body">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea required class="form-control" placeholder="Body" name="blog_body" rows="2" id="blog"><?= $result['blog_body'] ?></textarea>
                        </div>
                        <div class="mb-3">
    ...
    if (!empty($filename)) {
        if (in_array($image_ext, $allowed_types)) {
            if ($size <= 2000000) {
                ...
                $query = mysqli_query($config, $sql3);

                if ($query) {
                    $msg = ['Update successful', 'alert-success'];
                    $_SESSION['msg'] = $msg;
                    header("location:index.php");
                    exit();
                } else {
